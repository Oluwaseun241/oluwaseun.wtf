  ...
  return (
    <Animation>
      <div className="min-h-screen bg-white dark:bg-black p-8">
        <div className="max-w-3xl mx-auto space-y-16 pt-12">
          {/* Header */}
          <motion.div
          ...
          >
            <div className="prose max-w-none">
              <h2 className="text-4xl font-medium dark:text-white mb-6">
                Let's connect
              </h2>
              ...
              <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
                ...
                <div className="space-y-6">
                  <a
                    ...
                    className="group flex items-center gap-4 text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white transition-colors"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-lg">tanimolaoluwaseun70@gmail.com</span>
                  </a>
